...
export default function ArmaTuPizza({ cart, setCart }) {
        ...
        async function fetchIngredients() {
            try {
                ...
                const formatted = data
                    .filter(ing => ing.stock > 0 && ing.name.toLowerCase() !== "masa tradicional") // Excluye "masa tradicional"
                    .map(ing => ({
                        id: ing.id,
                        name: ing.name,
                        price: ing.price || 500,
                        ...
                        color: ing.color || null, // Asegura que las salsas tengan color
                        stock: ing.stock
                    }));
    ...
    const drawPizza = () => {
        ...
        drawPixelSquare(ctx, centerX, centerY, 260, "#F59E0B", "#D97706", 12); // Base de la pizza

        // Salsa (cubre el centro de la pizza)
        ...
        // Toppings (se dibujan como stickers)
